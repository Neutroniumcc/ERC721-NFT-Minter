...
contract NFT is ERC721Enumerable, Ownable {
  ...
  string public baseExtension = "YOUR JSON FILE"; 
  uint256 public cost = NAN; // Set this to your cost
  uint256 public maxSupply = 1; // maximum of minting
  uint256 public maxMintAmount = 1; // maximum NFT for each wallet
  address public owner1 = 0x71c7656ec7ab88b098defb751b7401b5f6d8976f; // The wallet addresses you want to send your portion of the NFT
  address public owner2 = 0x71c7656ec7ab88b098defb751b7401b5f6d8976f; // the wallets that get paid when you withdraw any funds used for purchase
